<?php namespace App\Http\Controllers;
	...
	class AdminMembersSlugController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Photo','name'=>'photo','type'=>'text','validation'=>'required','width'=>'col-sm-9'];
